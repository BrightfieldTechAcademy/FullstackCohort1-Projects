                    ...
                    <table id="example" class="table table-striped fs-3 table-bordered nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo BASE_URL?>/studentDetails.php?studentId=<?php echo $details->id?>" class="text-decoration-none text-dark"><?php echo $details->firstname . ' ' . $details->middlename. ' ' .$details->lastname ?></a></td>
