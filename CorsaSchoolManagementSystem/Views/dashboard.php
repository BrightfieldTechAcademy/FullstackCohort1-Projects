                    ...
                    <table id="example" class="table table-striped fs-3 table-bordered nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo BASE_URL ?>/Views/studentDetails.php" class="text-decoration-none text-dark"><?php echo $details->firstname . ' ' . $details->middlename. ' ' .$details->lastname ?></a></td>
